...
#### Links:
- **Paper**: [Link to the paper](https://arxiv.org/pdf/2403.18913)
- **Project**: [Link to related project](https://lpiccinelli-eth.github.io/pub/unidepth/)
- **Code**: [Link to GitHub repository](https://github.com/lpiccinelli-eth/UniDepth)
